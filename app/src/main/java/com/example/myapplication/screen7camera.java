    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //서버로 전송하는 코드 넣기;
                Toast.makeText(getApplicationContext(), " 처리중입니다 ...", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(v.getContext(), Camera_Popup.class);
                //미션 보낼 사람
...
//    }
    ...
    public void back(View view) {
        Intent intent1 = new Intent(this,alarm_popup.class);
